...
get_filename_component(_filename "/home/rasp/catkin_ws/src/pigeon_imu_driver/mpu6050/srv/ResetIMU.srv" NAME_WE)
add_custom_target(_mpu6050_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mpu6050" "/home/rasp/catkin_ws/src/pigeon_imu_driver/mpu6050/srv/ResetIMU.srv" ""
)
...
_generate_srv_cpp(mpu6050
  "/home/rasp/catkin_ws/src/pigeon_imu_driver/mpu6050/srv/ResetIMU.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mpu6050)
  install(CODE "execute_process(COMMAND \"/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mpu6050\")")
  # install generated code
  install(
