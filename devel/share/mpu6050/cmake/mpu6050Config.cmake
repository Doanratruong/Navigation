...
if("TRUE" STREQUAL "TRUE")
  set(mpu6050_SOURCE_PREFIX /home/rasp/catkin_ws/src/pigeon_imu_driver/mpu6050)
  set(mpu6050_DEVEL_PREFIX /home/rasp/catkin_ws/devel)
  set(mpu6050_INSTALL_PREFIX "")
  set(mpu6050_PREFIX ${mpu6050_DEVEL_PREFIX})
else()
  set(mpu6050_SOURCE_PREFIX "")
  set(mpu6050_DEVEL_PREFIX "")
  set(mpu6050_INSTALL_PREFIX /home/rasp/catkin_ws/install)
...
if(NOT "/home/rasp/catkin_ws/devel/include;/home/rasp/catkin_ws/src/pigeon_imu_driver/mpu6050/include " STREQUAL " ")
  set(mpu6050_INCLUDE_DIRS "")
  set(_include_dirs "/home/rasp/catkin_ws/devel/include;/home/rasp/catkin_ws/src/pigeon_imu_driver/mpu6050/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpu6050' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rasp/catkin_ws/src/pigeon_imu_driver/mpu6050/${idir}'.  ${_report}")
    endif()
