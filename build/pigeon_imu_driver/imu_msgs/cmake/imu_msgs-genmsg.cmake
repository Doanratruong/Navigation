...
set(MSG_I_FLAGS "-Iimu_msgs:/home/rasp/catkin_ws/src/pigeon_imu_driver/imu_msgs/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/rasp/catkin_ws/src/pigeon_imu_driver/imu_msgs/msg/Angle.msg" NAME_WE)
add_custom_target(_imu_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "imu_msgs" "/home/rasp/catkin_ws/src/pigeon_imu_driver/imu_msgs/msg/Angle.msg" ""
)
...
_generate_msg_cpp(imu_msgs
  "/home/rasp/catkin_ws/src/pigeon_imu_driver/imu_msgs/msg/Angle.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/imu_msgs)
  install(CODE "execute_process(COMMAND \"/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/imu_msgs\")")
  # install generated code
  install(
